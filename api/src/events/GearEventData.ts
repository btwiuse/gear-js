import { u32, u128, Vec, Option, BTreeMap, BTreeSet, GenericEventData, Bool } from 'https://deno.land/x/polkadot@0.2.16/types/mod.ts';
import { BlockNumber, AccountId32 } from 'https://deno.land/x/polkadot@0.2.16/types/interfaces/index.ts';
