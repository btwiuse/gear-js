import { AddressOrPair, SignerOptions, SubmittableExtrinsic } from 'https://deno.land/x/polkadot@0.2.45/api/types/index.ts';
import { Hash, RuntimeDispatchInfo } from 'https://deno.land/x/polkadot@0.2.45/types/interfaces/index.ts';
import { ISubmittableResult } from 'https://deno.land/x/polkadot@0.2.45/types/types/index.ts';
import { isFunction } from 'https://deno.land/x/polkadot@0.2.45/util/index.ts';
